...
def detect_objects(img, session):
    ...
    roi_points = np.array([[430, 260], [540, 260], [810, 460], [200, 460]])
    ...
    for i, (batch_id, x0, y0, x1, y1_box, cls_id, score) in enumerate(outputs):
        ...
        cv2.polylines(image, [roi_points.reshape((-1, 1, 2))], True, (255, 0, 0), thickness=2)
    ...
    return image, object_names_in_roi
